...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 h-[calc(100vh-2rem)] sticky top-4 my-4 ml-4 flex flex-col justify-between bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all z-20">
      <div>
        {/* Logo Brand Header */}
